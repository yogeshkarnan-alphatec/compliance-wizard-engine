...
export default function ImportPage() {
  ...
  return (
    <section className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold tracking-tight text-slate-900 dark:text-white">Import a directive</h1>
        <p className="text-sm text-slate-500 dark:text-slate-400">
          Search EU legislation and ingest it, or upload a document directly — both run the same pipeline.
        </p>
      </div>
